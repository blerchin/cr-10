...
#define STRING_CONFIG_H_AUTHOR "(Creality CR-10S w/ Titan Aero)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10S Titan Aero"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 405.36 }
